...
#include "rosidl_runtime_c/primitives_sequence.h"  // motor_angles, motor_speeds
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // motor_angles, motor_speeds
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motor_speeds
  {
    size_t size = ros_message->motor_speeds.size;
    auto array_ptr = ros_message->motor_speeds.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: motor_angles
  {
    size_t size = ros_message->motor_angles.size;
    auto array_ptr = ros_message->motor_angles.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motor_speeds
  {
    ...
    if (ros_message->motor_speeds.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->motor_speeds);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->motor_speeds, size)) {
      return "failed to create array for field 'motor_speeds'";
    }
    auto array_ptr = ros_message->motor_speeds.data;
  ...
  // Field name: motor_angles
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->motor_angles.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->motor_angles);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->motor_angles, size)) {
      return "failed to create array for field 'motor_angles'";
    }
    auto array_ptr = ros_message->motor_angles.data;
    cdr.deserializeArray(array_ptr, size);
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name motor_speeds
  {
    size_t array_size = ros_message->motor_speeds.size;
    auto array_ptr = ros_message->motor_speeds.data;
  ...
  // field.name motor_angles
  {
    size_t array_size = ros_message->motor_angles.size;
    auto array_ptr = ros_message->motor_angles.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
