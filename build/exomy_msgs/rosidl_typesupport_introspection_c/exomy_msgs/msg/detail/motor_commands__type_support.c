...
#include <stddef.h>
#include "exomy_msgs/msg/detail/motor_commands__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  exomy_msgs__msg__MotorCommands__init(message_memory);
}

void MotorCommands__rosidl_typesupport_introspection_c__MotorCommands_fini_function(void * message_memory)
{
  exomy_msgs__msg__MotorCommands__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MotorCommands__rosidl_typesupport_introspection_c__MotorCommands_message_member_array[2] = {
  {
    "motor_speeds",  // name
    ...
    offsetof(exomy_msgs__msg__MotorCommands, motor_speeds),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(exomy_msgs__msg__MotorCommands, motor_angles),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MotorCommands__rosidl_typesupport_introspection_c__MotorCommands_message_members = {
  ...
  2,  // number of fields
  sizeof(exomy_msgs__msg__MotorCommands),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, exomy_msgs, msg, MotorCommands)() {
