...
bool exomy_sim_msgs__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("exomy_sim_msgs.msg._joint_command.JointCommand", full_classname_dest, 46) == 0);
  }
  exomy_sim_msgs__msg__JointCommand * ros_message = _ros_message;
  {  // header
...
PyObject * exomy_sim_msgs__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("exomy_sim_msgs.msg._joint_command");
