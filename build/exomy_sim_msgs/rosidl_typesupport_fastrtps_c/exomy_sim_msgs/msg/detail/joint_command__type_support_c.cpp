...
#include "exomy_sim_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // mode, name
#include "rosidl_runtime_c/string_functions.h"  // mode, name
...
using _JointCommand__ros_msg_type = exomy_sim_msgs__msg__JointCommand;
...
static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_exomy_sim_msgs__msg__JointCommand(
...
{
  return max_serialized_size_exomy_sim_msgs__msg__JointCommand(
    full_bounded, 0);
}
